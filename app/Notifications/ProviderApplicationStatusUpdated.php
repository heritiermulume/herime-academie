...
class ProviderApplicationStatusUpdated extends Notification
{
    use Queueable;

    protected ProviderApplication $application;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'button_url' => route('provider-application.status', $this->application),
            'status' => $status,
    ...
    protected function resolveMessage(string $status): array
    {
        ...
        return match ($status) {
            ...
            'approved' => [
                'title' => 'Félicitations ! Vous êtes désormais prestataire',
                'message' => 'Votre candidature a été acceptée. Vous pouvez commencer à créer vos contenus dès maintenant.',
                'type' => 'success',
            ],
            'rejected' => [
            ...
            default => [
                'title' => 'Mise à jour de votre candidature prestataire',
