...
class InstructorPayoutReceivedMail extends Mailable
{
     ...
     */
    public function __construct(InstructorPayout $payout)
    {
        $this->payout = $payout;
    }
    ...
    public function content(): Content
    {
        ...
        $this->payout->load(['course', 'order', 'instructor']);
        ...
        return new Content(
            view: 'emails.instructor-payout-received',
            with: [
                'payout' => $this->payout,
