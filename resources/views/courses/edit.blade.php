...
@section('admin-actions')
    <a href="{{ route('instructor.courses.index') }}" class="admin-btn outline" data-temp-upload-cancel>
        <i class="fas fa-arrow-left me-2"></i>Retour à mes cours
    </a>
    <a href="{{ route('instructor.courses.show', $course->slug) }}" class="admin-btn primary" target="_blank">
...
@section('admin-content')
    ...
    <form action="{{ route('instructor.courses.update', $course) }}" method="POST" id="courseForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card shadow-sm mb-4 form-actions-card">
                    <div class="card-body">
                        <div class="form-actions d-flex flex-column flex-sm-row gap-2 align-items-stretch align-items-sm-center">
                            <a href="{{ route('instructor.courses.index') }}" class="btn btn-secondary form-actions__btn" data-temp-upload-cancel>
                                <i class="fas fa-times me-1"></i>Annuler
                            </a>
                            <button type="submit" class="btn btn-primary form-actions__btn form-actions__btn--primary">
                                <i class="fas fa-check me-1"></i>Mettre à jour le cours
                            </button>
                        </div>
                    </div>
                </div>
