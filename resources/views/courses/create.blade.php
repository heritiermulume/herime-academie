...
@section('admin-content')
    ...
    <form action="{{ route('instructor.courses.store') }}" method="POST" id="courseForm" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" 
                                          ...
                                          rows="3"
                                          placeholder="Une introduction concise affichée dans la liste des cours">{{ old('short_description') }}</textarea>
