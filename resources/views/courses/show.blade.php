                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center mb-2">
                                    <img src="{{ $review->user->avatar ? Storage::url($review->user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($review->user->name) . '&background=003366&color=fff' }}" 
                            ...
                            <div class="card-body d-flex flex-column p-3">
                                ...
                                <div class="mb-2">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ $relatedCourse->instructor->avatar ? Storage::url($relatedCourse->instructor->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($relatedCourse->instructor->name) . '&background=003366&color=fff' }}" 
