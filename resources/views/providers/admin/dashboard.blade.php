...
@section('admin-title', 'Tableau de bord prestataire')
@section('admin-subtitle', 'Suivez vos performances, vos contenus et l’engagement de vos clients en temps réel.')
        ...
        <div class="admin-panel__body">
            <div class="dashboard-activity">
                <div class="dashboard-activity__list">
                    <h3 class="dashboard-activity__title">Nouveaux contenus</h3>
                    <ul class="dashboard-activity__items">
                        ...
                        @empty
                            <li class="dashboard-activity__empty">Aucun contenu récent.</li>
                        @endforelse
                    </ul>
                </div>
                <div class="dashboard-activity__list">
                        ...
                        @forelse($recentEnrollments as $enrollment)
                            <li class="dashboard-activity__item">
                                <div>
                                    ...
                                    <span>{{ $enrollment->content?->title }}</span>
                                </div>
    ...
    <article class="admin-panel">
        ...
        <div class="admin-panel__body">
            <div class="dashboard-actions">
                <a href="{{ route('provider.contents.create') }}" class="dashboard-actions__item">
                    <i class="fas fa-rocket"></i>
                    <span>Lancer un nouveau contenu</span>
                </a>
                <a href="{{ route('provider.customers') }}" class="dashboard-actions__item">
                    <i class="fas fa-user-graduate"></i>
                    <span>Voir mes clients</span>
                </a>
                <a href="{{ route('provider.analytics') }}" class="dashboard-actions__item">
                    <i class="fas fa-chart-pie"></i>
                    <span>Performance des contenus</span>
                </a>
                <a href="{{ route('provider.payment-settings') }}" class="dashboard-actions__item">
