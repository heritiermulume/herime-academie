...
@section('admin-actions')
    <a href="{{ route('customer.contents') }}" class="admin-btn primary">
...
<section class="admin-panel">
    ...
    <div class="admin-panel__body">
        ...
        @else
                ...
                @foreach($certificates as $certificate)
                    <div class="student-certificate-item">
                        ...
                        <div class="student-certificate-item__info">
                            ...
                            <p>
                                {{ $certificate->course->provider->name ?? 'Herime Académie' }}
            ...
            <x-customer.pagination :paginator="$certificates" :showInfo="true" itemName="certificats" />
        @endif
    </div>
</section>
@endsection
