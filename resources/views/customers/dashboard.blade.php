...
@section('admin-actions')
    <a href="{{ route('contents.index') }}" class="admin-btn primary">
        <i class="fas fa-search me-2"></i>Découvrir de nouveaux contenus
    </a>
...
<section class="admin-panel admin-panel--main">
    <div class="admin-panel__body">
                ...
                <div class="student-highlight__content">
                    <div>
                        ...
                        <p class="student-highlight__subtitle">
                            {{ $highlightCourse->provider->name ?? 'Prestataire' }}
        ...
        <div class="admin-card student-highlight empty">
            <div class="student-highlight__content">
                ...
                <div class="student-highlight__actions">
                    <a href="{{ route('contents.index') }}" class="admin-btn primary lg">
    ...
    <section class="admin-panel">
        <div class="admin-panel__header">
            ...
            <div class="admin-panel__actions">
                <a href="{{ route('customer.certificates') }}" class="admin-btn soft">
        ...
        <div class="admin-panel__body">
            @if($certificates->isEmpty())
                <div class="admin-empty-state">
                    ...
                    <a href="{{ route('customer.contents') }}" class="admin-btn primary sm mt-3">
    ...
    <section class="admin-panel">
        <div class="admin-panel__header">
            ...
            <div class="admin-panel__actions">
                <a href="{{ route('contents.index') }}" class="admin-btn soft">
                    Explorer davantage
                </a>
            </div>
        </div>
