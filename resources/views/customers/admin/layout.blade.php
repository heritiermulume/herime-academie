...
@php
    ...
    $navItems = [
        ...
        [
            ...
            'url' => url('/customer/certificates'),
            'active' => ['customer.certificates'],
        ],
        [
            'label' => 'Commandes',
            'icon' => 'fas fa-receipt',
    ...
    $pageTitle = trim($__env->yieldContent('admin-title')) ?: 'Espace client';
        ...
        <div class="admin-sidebar">
            <div class="admin-sidebar__brand">
                <div class="admin-sidebar__avatar">
                    <img src="{{ $customer?->avatar_url ?? asset('images/default-avatar.png') }}" alt="{{ $customer?->name }}">
                </div>
