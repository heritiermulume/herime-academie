<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-primary text-white py-3">
        <h5 class="mb-0 fw-bold">Informations du contenu</h5>
    </div>
    <div class="card-body">
        <div class="mb-3">
            <h6 class="fw-bold">Prestataire</h6>
            <div class="d-flex align-items-center">
                <img src="{{ $course->provider->avatar ? $course->provider->avatar : 'https://ui-avatars.com/api/?name=' . urlencode($course->provider->name) . '&background=003366&color=fff' }}"
                     alt="{{ $course->provider->name }}" class="rounded-circle me-2" width="30" height="30">
