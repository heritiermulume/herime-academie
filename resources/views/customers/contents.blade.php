    ...
    <div class="admin-panel__body">
        <div class="admin-stats-grid">
            ...
            <div class="admin-stat-card">
                ...
                <p class="admin-stat-card__muted">Contenus actifs actuellement</p>
            </div>
            <div class="admin-stat-card">
...
<section class="admin-panel">
    ...
    <div class="admin-panel__body">
            ...
            <div class="modern-filters__row">
                ...
                <div class="modern-filters__actions">
                    ...
                    @if($search || (isset($statusFilter) && $statusFilter !== 'all'))
                        <a href="{{ route('customer.contents') }}" class="modern-filters__btn modern-filters__btn--reset">
                            <i class="fas fa-times"></i>
        ...
        @else
                    ...
                    <div class="customer-course-item">
                            ...
                            @else
                                @if(!$isPurchasedNotEnrolled)
                                    <div class="customer-progress">
                                        <div class="customer-progress__meta">
                                ...
                                @else
                                    <div class="customer-progress">
                                        ...
                                        <div class="customer-progress__bar" style="background-color: rgba(30, 58, 138, 0.1);">
                        ...
                        <div class="customer-course-item__actions">
                            @if($isPurchasedNotEnrolled)
                                ...
                                @else
                                    {{-- Contenu non téléchargeable : conserver la logique d'inscription --}}
            ...
            <x-customer.pagination :paginator="$enrollments" :showInfo="true" itemName="contenu" />
        @endif
    </div>
</section>
@endsection
...
<style>
    * {
    ...
    .customer-course-item:hover {
        transform: translateY(-3px);
        box-shadow: 0 18px 45px -35px rgba(30, 58, 138, 0.28);
    }

    .customer-course-item__meta {
        display: flex;
        gap: 1rem;
        align-items: center;
    }

    .customer-course-item__thumbnail {
        width: 56px;
        height: 56px;
        border-radius: 1rem;
        overflow: hidden;
    ...
    .customer-course-item__thumbnail img {
        width: 100%;
        height: 100%;
        object-fit: cover;
    }

    .customer-course-item__meta h4 {
        font-size: 1rem;
        margin: 0 0 0.25rem;
        font-weight: 700;
        color: var(--student-primary-dark);
    ...
    .customer-course-item__meta p {
        margin: 0;
        font-size: 0.85rem;
        color: var(--student-muted);
    }

    .customer-course-item__progress {
        display: flex;
        flex-direction: column;
        gap: 0.75rem;
    }
    ...
    .customer-course-item__status {
        display: flex;
        align-items: center;
    }

    .customer-course-item__actions {
        display: flex;
        flex-direction: column;
        gap: 0.5rem;
    ...
    @media (max-width: 767.98px) {
        ...
        .customer-course-item__actions .admin-btn {
            width: 100%;
        }
