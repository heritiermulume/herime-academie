    ...
    <div class="admin-panel__body">
        <div class="admin-stats-grid">
            ...
            <div class="admin-stat-card">
                ...
                <p class="admin-stat-card__muted">Cours accessibles immédiatement</p>
            </div>
            <div class="admin-stat-card">
...
<section class="admin-panel">
    ...
    <div class="admin-panel__body">
        ...
        @else
                    ...
                    <article class="student-order-card">
                        ...
                        <div class="student-order-card__body">
                            ...
                            <div class="student-order-card__meta">
                                ...
                                <span><i class="fas fa-layer-group me-1"></i>{{ $order->orderItems->count() > 0 ? $order->orderItems->count() : $order->enrollments->count() }} cours</span>
            ...
            <x-student.pagination :paginator="$orders" :showInfo="true" itemName="commandes" />
        @endif
    </div>
</section>
@endsection
