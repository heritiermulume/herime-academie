        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                        ...
                        <div class="mt-4">
                            ...
                            @if($application->status === 'approved')
                                ...
                                <div class="alert alert-success mt-3">
                                    ...
                                    <strong>Félicitations !</strong> Votre candidature a été approuvée. Vous pouvez maintenant accéder à l'espace prestataire.
                                    <div class="mt-3">
                                        <a href="{{ route('provider.dashboard') }}" class="btn btn-success">
                                            <i class="fas fa-tachometer-alt me-2"></i>Accéder à l'espace prestataire
                                        </a>
                                    </div>
                                </div>
                            @endif
                            ...
                            @if($application->status === 'rejected')
                                ...
                                @if($application->canBeEdited())
                                    <div class="alert alert-info mt-3">
                                        ...
                                        <div class="mt-3">
                                            <a href="{{ route('provider-application.create') }}" class="btn btn-primary">
                ...
                <div class="text-center mt-4 d-flex flex-column flex-md-row gap-2 justify-content-center">
                    @if($application->canBeEdited())
                        <a href="{{ route('provider-application.create') }}" class="btn btn-outline-primary">
                            <i class="fas fa-edit me-2"></i>Modifier ma candidature
                        </a>
                    @endif
                    <a href="{{ route('provider-application.index') }}" class="btn btn-secondary">
