...
@section('title', 'Candidature Prestataire - Étape 3 - Herime Academie')
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-lg">
                    <div class="card-body p-3 p-md-5">
                        ...
                        <form method="POST" action="{{ route('provider-application.store-step3', $application) }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    @if($application->cv_path)
                                        <div class="mt-2">
                                            <div class="alert alert-info d-flex align-items-center justify-content-between">
                                                ...
                                                <a href="{{ route('provider-application.download-cv', $application) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                                    ...
                                    @if($application->motivation_letter_path)
                                        <div class="mt-2">
                                            <div class="alert alert-info d-flex align-items-center justify-content-between">
                                                ...
                                                <a href="{{ route('provider-application.download-motivation-letter', $application) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                                                    <i class="fas fa-download me-1"></i>Voir
                                                </a>
                                            </div>
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between gap-2 mt-4 mt-md-5">
                                <a href="{{ route('provider-application.step2', $application) }}" class="btn btn-outline-secondary order-2 order-md-1">
