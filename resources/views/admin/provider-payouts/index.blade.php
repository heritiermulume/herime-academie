...
@section('title', 'Paiements aux prestataires externes')
@section('admin-title', 'Paiements aux prestataires externes')
@section('admin-subtitle', 'Suivez les paiements effectués via pawaPay aux prestataires externes')
    ...
    <section class="admin-panel admin-panel--main">
        <div class="admin-panel__body">
            ...
            <x-admin.search-panel
                :action="route('admin.provider-payouts')"
            ...
            >
                <x-slot:filters>
                    ...
                    <div class="d-flex justify-content-between align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.provider-payouts') }}" class="btn btn-outline-secondary">
            ...
            <div class="alert alert-info d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                <div>
                    ...
                    @if(request('provider_id'))
                        <span class="badge bg-warning ms-2">Prestataire: {{ $providers->firstWhere('id', request('provider_id'))->name ?? 'N/A' }}</span>
                    @endif
                </div>
                <a href="{{ route('admin.provider-payouts') }}" class="btn btn-sm btn-outline-danger">
