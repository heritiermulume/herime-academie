...
@section('admin-content')
    ...
    <form action="{{ route('admin.contents.store') }}" method="POST" id="courseForm" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" 
                                          ...
                                          rows="3"
                                          placeholder="Une introduction concise affichée dans la liste des contenus">{{ old('short_description') }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="requires_subscription" name="requires_subscription" value="1"
                                           {{ old('requires_subscription') ? 'checked' : '' }}
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_sale_enabled" name="is_sale_enabled" value="1" 
                                           {{ old('is_sale_enabled', true) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="form-actions d-flex flex-column flex-sm-row gap-2 align-items-stretch align-items-sm-center">
                            ...
                            <button type="submit" class="btn btn-primary form-actions__btn form-actions__btn--primary">
                                <i class="fas fa-check me-1"></i>Créer le contenu
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body course-lesson-card__body">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6">
                    ...
                    <div class="upload-zone upload-zone--droppable lesson-upload-zone" id="lessonUploadZone-${lessonUniqueId}" data-lesson-unique="${lessonUniqueId}" data-lesson-section="${sectionId}" data-lesson-index="${lessonCount}" onclick="triggerLessonFile('${lessonUniqueId}', event)">
                        <input type="file"
...
(function() {
    ...
    function uploadRichEditorImageInChunks(file, onProgress) {
        return new Promise((resolve, reject) => {
            ...
            // Ne pas appeler upload() tout de suite après addFile() : Resumable construit
            // les morceaux en setTimeout(0) ; un upload immédiat ne trouve aucun chunk,
            // déclenche « complete » et n'envoie jamais le fichier (progression bloquée à 0%).
            resumable.on('chunkingComplete', function () {
                if (!resumable.isUploading()) {
                    resumable.upload();
                }
