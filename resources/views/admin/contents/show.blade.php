...
@section('title', 'Détails du contenu - Admin')
...
@section('admin-actions')
    <div class="admin-actions-grid">
        <a href="{{ route('admin.contents.edit', $course) }}" class="btn btn-primary">
            <i class="fas fa-edit me-2"></i>Modifier
        </a>
        <a href="{{ route('contents.show', $course) }}" class="btn btn-outline-secondary" target="_blank">
            <i class="fas fa-external-link-alt me-2"></i>Voir sur le site
        </a>
        <a href="{{ route('admin.contents') }}" class="btn btn-light">
...
@php
    ...
    $totalStudents = $stats['total_customers'] ?? ($course->enrollments_count ?? null);
...
@endphp
    ...
    <section class="admin-panel mb-4">
        <div class="admin-panel__header">
            <h3>
                <i class="fas fa-image me-2"></i>Image du contenu
            </h3>
        </div>
    ...
    <div class="row g-4">
        <div class="col-md-8">
            <section class="admin-panel">
                <div class="admin-panel__header">
                    <h3>
                        <i class="fas fa-book me-2"></i>Informations du contenu
                    </h3>
                </div>
            ...
            <section class="admin-panel">
                ...
                <div class="admin-panel__body">
                    @if($sectionsCollection->isEmpty())
                        <p class="text-muted mb-0">Aucune section définie pour ce contenu.</p>
                    @else
        ...
        <div class="col-md-4">
            <section class="admin-panel">
                ...
                <div class="admin-panel__body">
                    <dl class="row mb-0">
                        ...
                        <dt class="col-sm-6">Clients inscrits</dt>
                        <dd class="col-sm-6">
            ...
            <section class="admin-panel">
                ...
                <div class="admin-panel__body">
                    <div class="d-flex align-items-start gap-3">
                        <img src="{{ $course->provider->avatar ?? asset('images/default-avatar.svg') }}" 
                             alt="{{ $course->provider->name ?? 'Prestataire' }}" 
                             class="rounded-circle flex-shrink-0"
                             style="width: 80px; height: 80px; object-fit: cover;">
                        <div class="flex-grow-1" style="min-width: 0;">
                            <h5 class="mb-2">{{ $course->provider->name ?? 'Non assigné' }}</h5>
                            @if($course->provider)
                                <a href="{{ route('admin.users.show', $course->provider) }}" class="btn btn-sm btn-outline-primary">
            ...
            <section class="admin-panel">
                <div class="admin-panel__header">
                    <h3>
                        <i class="fas fa-toggle-on me-2"></i>Options du contenu
                    </h3>
                </div>
                <div class="admin-panel__body">
                    <dl class="row mb-0">
    ...
    <!-- Modal pour la prévisualisation vidéo du contenu -->
    @if($videoPreviewUrl)
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="previewVideoModalLabel">Prévisualisation du contenu</h5>
...
/* S'assurer que le contenu de la section Prestataire reste dans les limites */
...
/* Styles pour l'image du contenu */
