                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <button type="button" class="btn btn-{{ $banner->is_active ? 'warning' : 'success' }} btn-sm" 
                                            ...
                                            <a href="{{ route('admin.banners.edit', $banner) }}" class="btn btn-primary btn-sm" title="Modifier">
