            ...
            <div class="card border-0 shadow">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-edit me-2"></i>Modifier la bannière
                        </h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('subtitle') is-invalid @enderror" 
                                          id="subtitle" name="subtitle" rows="2">{{ old('subtitle', $banner->subtitle) }}</textarea>
                                @error('subtitle')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="form-text text-muted">Format recommandé: 1920x1080px (Full HD). Laissez vide pour conserver l'image actuelle.</small>
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="form-text text-muted">Format recommandé: 1920x1080px (16:9). Laissez vide pour conserver l'image actuelle.</small>
                                @error('mobile_image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('button1_text') is-invalid @enderror" 
                                       id="button1_text" name="button1_text" value="{{ old('button1_text', $banner->button1_text) }}">
                                @error('button1_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('button1_url') is-invalid @enderror" 
                                       id="button1_url" name="button1_url" value="{{ old('button1_url', $banner->button1_url) }}">
                                @error('button1_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('button1_style') is-invalid @enderror" 
                                    ...
                                    <option value="primary" {{ old('button1_style', $banner->button1_style) == 'primary' ? 'selected' : '' }}>Primary</option>
                                    <option value="warning" {{ old('button1_style', $banner->button1_style) == 'warning' ? 'selected' : '' }}>Warning</option>
                                    <option value="success" {{ old('button1_style', $banner->button1_style) == 'success' ? 'selected' : '' }}>Success</option>
                                    <option value="danger" {{ old('button1_style', $banner->button1_style) == 'danger' ? 'selected' : '' }}>Danger</option>
                                    <option value="info" {{ old('button1_style', $banner->button1_style) == 'info' ? 'selected' : '' }}>Info</option>
                                </select>
                                @error('button1_style')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('button2_text') is-invalid @enderror" 
                                       id="button2_text" name="button2_text" value="{{ old('button2_text', $banner->button2_text) }}">
                                @error('button2_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('button2_url') is-invalid @enderror" 
                                       id="button2_url" name="button2_url" value="{{ old('button2_url', $banner->button2_url) }}">
                                @error('button2_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            document.getElementById('imagePreview').innerHTML = 
                `<strong>Nouvelle image:</strong><br><img src="${e.target.result}" class="img-thumbnail mt-2" style="max-width: 300px;">`;
        }
