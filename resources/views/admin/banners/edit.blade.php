                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="current-image mb-3">
                                    ...
                                    <img src="{{ $banner->image }}" alt="Image actuelle" class="img-thumbnail" style="max-height: 200px;">
                                </div>
                                @endif
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="current-image mb-3">
                                    ...
                                    <img src="{{ $banner->mobile_image }}" alt="Image mobile actuelle" class="img-thumbnail" style="max-height: 200px;">
                                </div>
                                @endif
