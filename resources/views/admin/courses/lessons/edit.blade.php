                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mb-3" id="content-url-field">
                                        ...
                                        <div>
                                            <label class="form-label small">Ou téléverser un nouveau fichier</label>
                                            <div class="upload-zone" id="contentUploadZone">
                                                ...
                                                <div class="upload-placeholder text-center p-3" onclick="document.getElementById('content_file').click()">
                                                    ...
                                                    <p class="mb-1 small"><strong>Cliquez pour changer le fichier</strong></p>
        ...
        if (input.files && input.files[0]) {
            ...
            if (VALID_VIDEO_TYPES.includes(file.type)) {
                ...
                reader.onload = function(e) {
                    previewContent.innerHTML = `<video controls class="w-100 rounded" style="max-height: 200px; border: 3px solid #17a2b8;"><source src="${e.target.result}"></video>`;
                    placeholder.classList.add('d-none');
                    preview.classList.remove('d-none');
                };
                reader.readAsDataURL(file);
            } else if (VALID_PDF_TYPES.includes(file.type)) {
                previewContent.innerHTML = `<div class="alert alert-info text-center mb-0"><i class="fas fa-file-pdf fa-3x mb-2"></i><p class="mb-0">Nouveau PDF sélectionné</p></div>`;
                placeholder.classList.add('d-none');
                preview.classList.remove('d-none');
            }
            
            // Upload AJAX optionnel
            uploadLessonFileEdit(input);
        }
    }
