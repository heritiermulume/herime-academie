                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item border-0 py-3 {{ !$message->is_read ? 'bg-light' : '' }}">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-2">
                                                <img src="{{ $message->sender->avatar ? Storage::url($message->sender->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($message->sender->name) . '&background=003366&color=fff' }}" 
                            ...
                            @if($sentMessages->count() > 0)
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item border-0 py-3">
                                        <div class="row align-items-center">
                                            <div class="col-md-2">
                                                <img src="{{ $message->receiver->avatar ? Storage::url($message->receiver->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($message->receiver->name) . '&background=003366&color=fff' }}" 
