...
@section('content')
<!-- Hero Section -->
<section class="page-header-section" style="background: linear-gradient(135deg, #003366 0%, #004080 100%); padding: 4rem 0;">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center text-white">
                <h1 class="display-4 fw-bold mb-3">Devenir Formateur</h1>
                <p class="lead mb-4">Partagez votre expertise et transformez des vies grâce à l'éducation en ligne</p>
                @auth
                    @if(auth()->user()->role !== 'instructor')
                        <a href="{{ route('instructor-application.create') }}" class="btn btn-light btn-lg px-5">
                ...
                @auth
                    @if(auth()->user()->role !== 'instructor')
                        <div class="text-center mt-5">
                            <a href="{{ route('instructor-application.create') }}" class="btn btn-primary btn-lg px-5 py-3">
