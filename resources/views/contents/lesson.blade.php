        ...
        <div class="col-lg-3">
            <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
                <div class="card-header bg-primary text-white">
                    <h6 class="mb-0">
                        <i class="fas fa-list me-2"></i>Programme du contenu
                    </h6>
                </div>
                                ...
                                <div id="collapse{{ $section->id }}" class="accordion-collapse collapse" 
                                    ...
                                    <div class="accordion-body p-2">
                                        @foreach($section->lessons as $sectionLesson)
                                            <a href="{{ route('contents.lesson', ['course' => $course->slug, 'lesson' => $sectionLesson->id]) }}" 
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-light">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('contents.show', $course->slug) }}">{{ $course->title }}</a></li>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-5 pt-4 border-top">
                        <div>
                            @if($previousLesson)
                                <a href="{{ route('contents.lesson', ['course' => $course->slug, 'lesson' => $previousLesson->id]) }}" 
                        ...
                        <div>
                            @if($nextLesson)
                                <a href="{{ route('contents.lesson', ['course' => $course->slug, 'lesson' => $nextLesson->id]) }}" 
