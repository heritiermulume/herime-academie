{{-- Carte contenu (liste) — réutilisée par contents/index et le scroll infini AJAX --}}
    ...
    <div class="course-card" data-course-url="{{ route('contents.show', $course->slug) }}" style="cursor: pointer;">
        <div class="card course-card-inner" style="position: relative;">
                    ...
                    @if($course->requires_subscription)
                        <a href="{{ auth()->check() ? route('customer.subscriptions') : route('login') }}"
                           ...
                           onclick="event.stopPropagation();">
                            <i class="fas fa-lock me-1"></i>{{ $course->requiredMemberPeriodLabel() }}
                        </a>
                    @endif
            ...
            <div class="card-body">
                ...
                <div class="card-actions pt-2" onclick="event.stopPropagation(); event.preventDefault();">
