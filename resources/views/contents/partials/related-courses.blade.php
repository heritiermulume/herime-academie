                        ...
                        <div class="card course-card-inner" style="position: relative;">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute top-0 end-0 m-2 d-flex flex-column gap-1">
                                    ...
                                    @endif
                                    @if($relatedCourse->requires_subscription)
                            ...
                            <div class="card-body">
                                ...
                                <div class="customers-count mb-2">
                                    <small class="text-muted">
                                        <i class="fas {{ $relatedCourse->is_downloadable ? 'fa-download' : 'fa-graduation-cap' }} me-1"></i>
                                        {{ $relatedCourse->is_downloadable ? 'Téléchargeable' : 'Formation' }}
                                    </small>
                                </div>
                                        ...
                                        @else
                                            @if($relatedCourse->is_sale_active && $relatedCourse->active_sale_price !== null)
                                                <div class="course-price-container">
                                                    ...
                                                    @if($relatedCourse->is_sale_active && (($relatedCourse->use_fake_promo_countdown ?? false) || $relatedCourse->sale_end_at))
                                                        <div class="course-price-row">
                                                            <div class="promotion-countdown"
                                                                 @if($relatedCourse->use_fake_promo_countdown ?? false)
                                                                     data-promo-duration-days="{{ max(1, (int) ($relatedCourse->fake_promo_duration_days ?? 3)) }}"
                                                                 @else
                                                                     data-sale-end="{{ $relatedCourse->sale_end_at->toIso8601String() }}"
                                                                 @endif>
