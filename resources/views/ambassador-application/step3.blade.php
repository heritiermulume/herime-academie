                ...
                <div class="card border-0 shadow-lg">
                    <div class="card-body p-3 p-md-5">
                        <div class="alert alert-info mb-4">
                            ...
                            <strong>Dernière étape !</strong> Partagez vos idées pour promouvoir nos formations et maximiser vos commissions.
                        </div>
                        ...
                        <form method="POST" action="{{ route('ambassador-application.store-step3', $application) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('marketing_ideas') is-invalid @enderror" 
                                          ...
                                          rows="6" 
                                          placeholder="Avez-vous des idées spécifiques pour promouvoir nos formations ? Comment comptez-vous utiliser votre code promo ? Quelles stratégies marketing envisagez-vous ? Partagez vos meilleures idées pour toucher votre audience.">{{ old('marketing_ideas', $application->marketing_ideas ?? '') }}</textarea>
