...
@section('title', 'Statut de ma Candidature Ambassadeur - Herime Academie')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                        ...
                        <div class="mt-4">
                            ...
                            @if($application->status === 'approved')
                                ...
                                <div class="alert alert-success mt-3">
                                    ...
                                    <strong>Félicitations !</strong> Votre candidature a été approuvée. Vous avez reçu un code promo unique que vous pouvez partager pour gagner des commissions.
                                    @php
                                        $ambassador = \App\Models\Ambassador::where('user_id', auth()->id())->first();
                                    ...
                                    @if($promoCode)
                                        <div class="mt-3">
                                            <div class="alert alert-info mb-3">
                                                ...
                                                <div class="h4 mb-0 mt-2">{{ $promoCode->code }}</div>
                                            </div>
                                            <a href="{{ route('ambassador.dashboard') }}" class="btn btn-success">
                            ...
                            @if($application->status === 'rejected')
                                ...
                                @if($application->canBeEdited())
                                    <div class="alert alert-info mt-3">
                                        ...
                                        <div class="mt-3">
                                            <a href="{{ route('ambassador-application.create') }}" class="btn btn-primary">
                        ...
                        <div class="row g-3">
                            ...
                            @if($application->document_path)
                                <div class="col-12">
                                    ...
                                    <div class="mt-2">
                                        <a href="{{ route('ambassador-application.download-document', $application) }}" class="btn btn-outline-primary btn-sm">
                                            <i class="fas fa-file-pdf me-2"></i>Télécharger le document PDF
                                        </a>
                                    </div>
                                </div>
                            @endif
                ...
                <div class="text-center mt-4 d-flex flex-column flex-md-row gap-2 justify-content-center">
                    @if($application->canBeEdited())
                        <a href="{{ route('ambassador-application.create') }}" class="btn btn-outline-primary">
                            <i class="fas fa-edit me-2"></i>Modifier ma candidature
                        </a>
                    @endif
                    <a href="{{ route('ambassador-application.index') }}" class="btn btn-secondary">
