                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card border-0 shadow-sm h-100 course-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            <h6 class="card-title fw-bold mb-2" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                {{ $course->title }}
                            </h6>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <small class="text-muted" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="text-muted">{{ number_format($course->stats['average_rating'] ?? 0, 1) }} ({{ $course->stats['total_reviews'] ?? 0 }})</small>
                                    </div>
                                    <span class="badge bg-light text-dark">{{ ucfirst($course->level) }}</span>
                                </div>
                                
                                <div class="d-flex align-items-center justify-content-between">
                                    <small class="text-muted">
                                        <i class="fas fa-clock me-1"></i>
                                        {{ $course->stats['total_duration'] ?? 0 }} min
                                    </small>
                                    <small class="text-muted">
                                        <i class="fas fa-play-circle me-1"></i>
                                        {{ $course->stats['total_lessons'] ?? 0 }} leçons
                                    </small>
                                </div>
                            </div>
...
/* Styles pour les cartes de cours dans le panier */
.course-card {
...
/* Amélioration des métadonnées des cours */
