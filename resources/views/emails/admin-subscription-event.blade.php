...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge { display: inline-block; padding: 8px 16px; background-color: #003366; color: #ffffff; border-radius: 20px; font-size: 14px; font-weight: 600; margin-bottom: 20px; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            @endif
            <h1>{{ $title }}</h1>
            <p>Notification administration</p>
        </div>

        <div class="content">
            <div class="badge">Email admin</div>
            <h2>Bonjour{{ !empty($adminName) ? ' '.$adminName : '' }},</h2>
            <p>{{ $intro }}</p>
