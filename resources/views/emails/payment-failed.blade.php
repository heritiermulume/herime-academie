...
<head>
    ...
    <title>Échec du paiement - {{ config('app.name') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Votre commande a été annulée. Vous pouvez réessayer de procéder au paiement en suivant les liens ci-dessous.</p>
