...
@section('admin-actions')
    @if(Route::has('instructor.courses.create'))
        <a href="{{ route('instructor.courses.create') }}" class="admin-btn primary">
            ...
            @forelse($courses as $course)
                <div class="courses-list__item">
                    ...
                    <div class="courses-list__content">
                        ...
                        <div class="courses-list__stats">
                            <div class="courses-list__stat">
                                ...
                                <span class="courses-list__stat-label">Étudiants</span>
                            </div>
                            <div class="courses-list__stat">
                    ...
                    <div class="courses-list__actions">
                        <a href="{{ route('courses.show', $course->slug) }}" class="admin-btn outline sm" target="_blank" title="Voir">
                            <i class="fas fa-eye"></i>
                            <span class="courses-list__action-label">Voir</span>
                        </a>
                        <a href="{{ route('instructor.courses.edit', $course) }}" class="admin-btn primary sm" title="Modifier">
                            <i class="fas fa-pen"></i>
                            <span class="courses-list__action-label">Modifier</span>
                        </a>
                        <a href="{{ route('instructor.courses.lessons', $course) }}" class="admin-btn soft sm" title="Leçons">
